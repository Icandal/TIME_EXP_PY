...
class InstructionScreen:
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        # Текст инструкции
        instruction_text = self.font_large.render("Нажмите ПРОБЕЛ чтобы продолжить", True, self.text_color)
        text_rect = instruction_text.get_rect(center=(self.screen_width // 2, self.screen_height // 2 - 20))
