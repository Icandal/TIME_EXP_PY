...
class Trajectory:
    ...
    def draw_start_point(self, screen: pygame.Surface) -> None:
        ...
        if self.points:
            ...
            pygame.draw.circle(screen, (0, 255, 0), start_point, 8)  # Зеленая точка старта
...
class TrajectoryManager:
    ...
    def load_trajectory(self, category: str, index: int) -> Trajectory:
        ...
        if category in self.trajectories_data and index < len(self.trajectories_data[category]):
